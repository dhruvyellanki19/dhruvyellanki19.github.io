  ...
  const experiences = [
    {
      ...
      highlights: [
        {
          title: "GraphRAG Pipeline on PostgreSQL & SurrealDB",
          description: "Architected a production GraphRAG pipeline on PostgreSQL and SurrealDB combining vector search, BM25, and multi-hop graph traversal with RRF fusion.",
          impact: "Cut proposal research time by 65% for business development teams",
          tech: ["PostgreSQL", "SurrealDB", "GraphRAG", "Vector Search", "BM25"],
        },
        {
          title: "Cross-Encoder Reranking Layer",
          description: "Engineered a cross-encoder reranking layer for the Graph RAG pipeline using ms-marco-MiniLM with context-aware multi-document ranking.",
          impact: "Improved proposal retrieval precision by 38% at sub-500ms retrieval latency",
          tech: ["Cross-Encoder", "ms-marco-MiniLM", "Reranking"],
        },
        {
          title: "LangGraph Orchestrator with GPT-4o Agents",
          description: "Fine-tuned a GPT-OSS-20B as a LangGraph orchestrator coordinating GPT-4o agents for automated proposal drafting, measured using RAGAS faithfulness and answer correctness.",
          impact: "Achieved 81% F1 and a 14% accuracy gain over manual baselines",
          tech: ["GPT-OSS-20B", "LangGraph", "GPT-4o", "RAGAS"],
        },
        {
        ...
        {
          title: "Context Graphs & OpenMemory Integration",
          description: "Designed Context Graphs in SurrealDB to persist agentic decision traces as queryable audit trails, integrating OpenMemory for salience-weighted long-term retrieval.",
          impact: "Reduced hallucination rates by 22% on factual grounding evals",
          tech: ["SurrealDB", "Context Graphs", "OpenMemory", "Agentic AI"],
        },
        {
          title: "ISO Compliant Production LLMOps",
          description: "Streamlined production LLMOps by architecting ISO compliant containerized CI/CD pipelines with Docker and Kubernetes.",
          impact: "Cut deployment cycles by 40% and sustaining 99.6% uptime for enterprise systems",
